...
class checking_tier_coach extends StatefulWidget {
  const checking_tier_coach({this.name, this.tier, this.images});
  final name;
  final tier;
  final images;

  @override
  State<checking_tier_coach> createState() => _checking_tier_coachState();
}

class _checking_tier_coachState extends State<checking_tier_coach> {
  String _name = 'default = 과제 많은 넙죽이';
